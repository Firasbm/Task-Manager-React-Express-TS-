...
var taskService = new task_service_1.default();
router.get("/", function (req, res) {
    res.send(taskService.getTask());
});
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error, task, newTask, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                error = task_dto_1.taskSchema.validate(req.body).error;
                if (error) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, taskService.createTask(task)];
            case 2:
                newTask = _a.sent();
